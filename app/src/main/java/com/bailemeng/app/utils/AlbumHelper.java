...
public class AlbumHelper {
    ...
    //单例
    public static AlbumHelper getInstance(Activity activity) {
        mActivity = activity;
        if (instance == null) {
        ...
        tpe.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (width == 0 || height == 0) {
                    ...
                    options.inSampleSize = computeScale(options, WindowUtil.getScreenWidth(mActivity), WindowUtil.getScreenHeight(mActivity));
                    ...
                    String hash = PhotoUtil.md5(path+"_"+width+"_"+height);
                    File file = new File(PhotoUtil.getDataPath(mActivity));
                    if (!file.exists())
                        file.mkdirs();
                    //临时文件的文件名
                    String tempPath = PhotoUtil.getDataPath(mActivity) + hash + ".temp";
